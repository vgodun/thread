...
function ThreadCard({
  ...
  const handleClick = (e: React.MouseEvent) => {
    // Only stop propagation if this is inside a tab
    const isInsideTab = (e.target as HTMLElement).closest('.tab');
    if (isInsideTab) {
      e.stopPropagation();
    }
  };
  ...
  return (
    <div onClick={handleClick}>
      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex w-full flex-1 flex-row gap-4">
            ...
            <div className="flex w-full flex-col">
              ...
              {imgPosts && <ModalPost imgUrl={imgPosts} />}
              ...
              <div className={`${isComment && "mb-10"} mt-5 flex flex-col gap-3`}>
                ...
                <div className="flex gap-3.5 justify-center item"></div>
              </div>
            </div>
          </div>
          <div className="flex">
        ...
        {/* Remove the absolute positioned link that captures all clicks */}
        {/* <Link
          href={`/thread/${id}`}
